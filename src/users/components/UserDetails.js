...
const UserDetails = () => {
    ...
    useEffect(() => {
        const LoadUser = async () => {
            setIsLoading(true);
            try {
                const request = await fetch(`${process.env.REACT_APP_BACKEND_URL}/user/${UserId}`);
    ...
    return <React.Fragment>
        ...
        { !isLoading && fetchedData && <div className="details-container">
            ...
            <div className="user-details-image">
                <Avatar src="https://cdn1.iconfinder.com/data/icons/app-user-interface-glyph/64/user_man_user_interface_app_person-512.png" />
            </div>
